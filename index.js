...
const locElem = document.getElementById('e.location')
const whichElem = document.getElementById('e.which')
const codeElem = document.getElementById('e.code')
const mainElem = document.getElementsByClassName('main__key')[0]
const alertContainer = document.getElementsByClassName('alerts__container')[0]
